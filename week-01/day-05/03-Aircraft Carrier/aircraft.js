class Aircrafts {
    ...
    refill(number) {
        this.ammoStorage = (this.ammoStorage + number)> this.maxAmmo? this.maxAmmo:this.ammoStorage+number;
        console.log(`test:ammoStorage ${this.ammoStorage} [line:15]`);
        this.remainAmmo = (this.ammoStorage + number)> this.maxAmmo ? number - this.ammoStorage : 0;
